...
; This defines a macro named `INTERRUPT_HANDLER` that takes one argument.
%macro INTERRUPT_HANDLER 1
global interrupt_handler_%1
interrupt_handler_%1:
    ; pushad & popad
    ; These instructions save and restore all general-purpose registers, respectively.
    pushad
    ...
    ; Return from an interrupt service routine (ISR).
    iret
%endmacro
...
INTERRUPT_HANDLER 0x21  ; keymap interrupt
...
INTERRUPT_HANDLER 0x28  ; RTC (Real-Time Clock)
